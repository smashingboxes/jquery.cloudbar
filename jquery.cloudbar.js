...
!function ( $, window, document, undefined ) {
    ...
    Plugin.prototype.generateSidebar = function() {
        ...
        var fn       = this,
            $sidebar = $("<div id='cloudbar'></div>").addClass(this.options.css).hide(),
            $list    = $("<ul></ul>"),
        ...
        this.sidebar_options = {
            initial_margin: parseInt($("#cloudbar").css("margin-left"), 10)
        };

        $sidebar.delay(200).fadeIn(500);
    ...
    Plugin.prototype.watchScroll = function() {
        ...
        $(window).scroll(function(e) {
            ...
            var sidebarTop = ( $this.scrollTop() > (fn.options.padding_initial * (1 - fn.options.padding_forgiveness))) ? fn.options.padding : fn.options.padding_initial;

            var sidebarLeft = (fn.sidebar_options.initial_margin - $this.scrollLeft());
            clearTimeout(func.timeout);

            func.timeout = setTimeout(function() {
                $("#cloudbar").animate({ top: sidebarTop, marginLeft: sidebarLeft }, 250);
            }, 100);
    ...
    Plugin.prototype.generateArrows = function() {
        ...
        $(this.options.taxonomy).not(":first").each(function(i) {
